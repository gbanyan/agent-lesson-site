...
B6 DOCX 原文保持不變；C2 原有 DOCX 圖解保留在同頁可展開區域。E7 的行事曆與通知用來說明外部影響，F3 保留秘密資料的安全案例。前言由作者本人直接維護；2026-09-10 起「關於本站」僅含前言，原本站說明段落已依作者決定移除。

F3 先以把登入密碼貼進共同文件說明風險，再解釋給程式用的私密金鑰。D6 全頁以圖片程式處理照片副本為例，區分口頭要求與環境實際限制，不引導讀者執行陌生程式。F3 與 E7 的危險 request 之前顯示明文警示，避免被當成示範指令。

## 作者檢查

逐頁一起核對情境、圖解、案例、Prompt 與結論。不為了固定情境而抹平權限、備份、驗證與外部影響的差異。英文名稱仍可搜尋；合併後不再保留舊網址。
